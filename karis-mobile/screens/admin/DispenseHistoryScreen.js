  ...
  render() {
    return(
      <View style={Styles.container}>
        ...
        />
        <AdminHeader navigation={this.props.navigation} headerTitle='Dispense History' previousScreen='DispenseHistory' />
        <ScrollView alwaysBounceVertical={false} contentContainerStyle={[Styles.scrollableContainer, Styles.content]}>
          ...
          <View style={{ height: 10 }} />
          {
            this.props.me.user.is_admin &&
            <CustomerFilter
              customers={this.props.minifiedCustomers}
              customer={this.props.dispenseHistories.params.customer}
              verbose={true}
              containerStyle={localStyles.dateFilterContainerStyle}
              onChange={this._setCustomer}
              />
          }
...
export default connect(mapStateToProps, mapDispatchToProps)(DispenseHistory);
