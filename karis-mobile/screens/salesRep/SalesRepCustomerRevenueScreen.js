...
class CustomerRevenue extends Component {
  ...
  async componentDidMount() {
    ...
    console.log(this.props.customerRevenues.results, "++++++++++++++++++++++++");
  }
          ...
          <Table
            ...
            footerCells={
              [
                ...
                <Text style={localStyles.footerCellsText} key={2}>{currencyFormatter(this.props.customerRevenues.totalMargin || 0)}</Text>
              ]
            }
          />
        </ScrollView>
