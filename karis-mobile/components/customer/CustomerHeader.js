...
class CustomerHeader extends Component {
  _goToCustomerSettings = async () => {
    await this.props.retrieveMe();
    this.props.navigation.navigate('CustomerSettings', { previousScreen: this.props.previousScreen });
  }
