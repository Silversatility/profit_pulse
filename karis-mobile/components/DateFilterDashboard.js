          ...
          >
            ...
            <Dialog.Content>
              ...
              >
                ...
                <Divider />
                <TouchableRipple onPress={() => this._setTemporaryDialogFilter('last_week')}>
                  <View style={localStyles.filterDialogItemRow}>
                    <RadioButton color={Colors.tint} value='last_week' />
                    <Text style={localStyles.filterDialogItemLabel}>{this._getDisplay('last_week')}</Text>
                  </View>
                </TouchableRipple>
                <Divider />
                ...
                <Divider />
                <TouchableRipple onPress={() => this._setTemporaryDialogFilter('last_month')}>
                  <View style={localStyles.filterDialogItemRow}>
                    <RadioButton color={Colors.tint} value='last_month' />
                    <Text style={localStyles.filterDialogItemLabel}>{this._getDisplay('last_month')}</Text>
                  </View>
                </TouchableRipple>
                <Divider />
