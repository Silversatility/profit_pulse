...
export default class CredentialingSingleCtrl {
    constructor($state, $rootScope, $stateParams, userService, MESSAGES, toast, confirmDeleteService) {
        this.$state = $state;
...
CredentialingSingleCtrl.$inject = ['$state', '$rootScope', '$stateParams', 'userService', 'MESSAGES', 'toast', 'confirmDeleteService'];
