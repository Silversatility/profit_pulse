export default class DashboardCtrl {
    constructor(dashboardService, userService, $filter, $location) {
        ...
        this.userService.currentUser().then(data => this.customer = data);
    }
    ...
    getDispenseHistoryReport(){
        this.dashboardService.getDispenseHistoryReport(this.filter.value, this.filterCustomer)
            .then(data => {
                this.reports = data;
    ...
    getNetProfits() {
        this.dashboardService.getTotalProfits(this.filter.value, this.filterCustomer)
            .then(data => {
    ...
    drawTopPerformingChart() {
        ...
        this.dashboardService.getTopPerformingProducts(this.filter.value)
            .then((data) => {
                this.topProducts = [];
    ...
    drawMyTopPerformingChart() {
        ...
        this.dashboardService.getMyTopPerformingProducts(this.filter.value, this.filterCustomer)
            .then((data) => {
    ...
    drawProfitabilityChart() {
        ...
        this.dashboardService.getPhysiciansTop(this.filter.value, this.filterCustomer)
            .then((data) => {
...
DashboardCtrl.$inject = ['DashboardService', 'userService', '$filter', '$location'];
