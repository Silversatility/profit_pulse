...
angular.module('app', [ngCookies, router, bootstrap, bootstrapDatetimePicker, 'ui.checkbox', 'angularjsToast', appStates, authService, directives])
  ...
  .config(function (uiDatetimePickerConfig) {
    uiDatetimePickerConfig.buttonBar.clear.show = false;
    uiDatetimePickerConfig.buttonBar.close.show = false;
    uiDatetimePickerConfig.buttonBar.date.show = false;
    uiDatetimePickerConfig.buttonBar.today.cls = 'btn-sm btn-info';
    uiDatetimePickerConfig.buttonBar.time.cls = 'btn-sm btn-success';
    uiDatetimePickerConfig.buttonBar.now.cls = 'btn-sm btn-success';
  })
  .run(appRun);
